          ...
          <div ref={ref} className='flex flex-col gap-8'>
            <motion.div
              ...
              <h1 className='font-medium w-full'>
                Dizajniramo stranice koje{' '} 
                <span className='instrument-font italic font-normal dark:text-white/70  relative w-full'>
                    donose{' '} 
              ...
              <p className='max-w-38 text-dark_black/60 dark:text-white/60'>
                Gradimo prilagođena web rješenja i aplikacije koje izgledaju vrhunski, 
                rade besprijekorno i pretvaraju posjetitelje u klijente. 
              </p>
            </motion.div>
            <motion.div
              {...bottomAnimation}
